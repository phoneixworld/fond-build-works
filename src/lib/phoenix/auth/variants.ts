...
function generateEmailPasswordAuth(): AuthTemplateSet {
  return {
    ...
    migrations: [],
    files: {
      "/auth/auth.client.js": AUTH_CLIENT_TEMPLATE,
      "/hooks/useSession.js": USE_SESSION_TEMPLATE,
      "/components/ProtectedRoute.jsx": PROTECTED_ROUTE_TEMPLATE,
      "/pages/LoginPage.jsx": LOGIN_PAGE_TEMPLATE,
      "/pages/SignupPage.jsx": SIGNUP_PAGE_TEMPLATE,
      "/utils/logout.js": LOGOUT_TEMPLATE,
      "/contexts/AuthContext.jsx": AUTH_CONTEXT_TEMPLATE,
    },
  };
}
...
function generateRoleBasedAuth(): AuthTemplateSet {
  return {
    ...
    files: {
      "/auth/auth.client.js": AUTH_CLIENT_TEMPLATE,
      "/hooks/useSession.js": USE_SESSION_TEMPLATE,
      "/hooks/useUserRole.js": USE_USER_ROLE_TEMPLATE,
      "/components/ProtectedRoute.jsx": PROTECTED_ROUTE_WITH_ROLES_TEMPLATE,
      "/pages/LoginPage.jsx": LOGIN_PAGE_TEMPLATE,
      "/pages/SignupPage.jsx": SIGNUP_PAGE_TEMPLATE,
      "/utils/logout.js": LOGOUT_TEMPLATE,
      "/contexts/AuthContext.jsx": AUTH_CONTEXT_TEMPLATE,
